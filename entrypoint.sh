...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/23b61ac0-276d-4485-a59e-fd3566692eea"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="23b61ac0-276d-4485-a59e-fd3566692eea"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/819a29c1-781c-4fdc-9e27-ad1ee10174d1"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="819a29c1-781c-4fdc-9e27-ad1ee10174d1"
fi
echo ${Vmess_UUID}
